...
public class Task4 {
	// —ортировка обменами
	// ƒана последовательность чисел a1<a2<...<an.
	// “ребуетс€ переставить числа в пор€дке возрастани€
	// дл€ этого сравниваетс€ два соседних числа и если нужно, делаетс€ перестановка
