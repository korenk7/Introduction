...
public class Task16 {
	...
	public static void main(String[] args) {
		...
		for (int i = (int) Math.pow(10, n - 1); i < Math.pow(10, n); i++) {
			...
			if (count == n) {
				System.out.print("число " + i + " состоит из нечетных чисел ");
				sumOfDigits = sumOfDigits(i);
				System.out.print("сумма цифр числа " + i + " = " + sumOfDigits);
				countOfEven = countOfEven(sumOfDigits);
				System.out.println(" количество четных цифр в ней " + countOfEven);
